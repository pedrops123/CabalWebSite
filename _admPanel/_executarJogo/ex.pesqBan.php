...
<div id="fbody" class="fbody">
    ...
    <div class="fdesc" align="right">
         <a onclick="new Ajax.Updater('container','_admPanel/ap.edtConta.php',{method: 'get',asynchronous:true,evalScripts:true}); esperar('container');" href="#"> Pesquisar conta</a> > <a href="#" onclick="new Ajax.Updater('container', '_admPanel/_executarJogo/ex.pesqConta.php?ID=<?=$PegaAcc['ID']?>', {method: 'get', asynchronous:true, evalScripts:true}); esperar('container');" >Editar conta</a> > Banir conta  
</div>
    </div>
...
<div class="flabel" style="">
      <div class="fitem" style=""><label for="rusername">Permitir Pergaminho</label></div>
      <div class="finput" style="">
       <select class="fsubmit" style="padding: 0; text-align: left; width: 98%; margin: 0;" name="txtPerg">
    ...
    <div class="flabel" style="">
     ...
     <input name="sbmtBanConta" class="fsubmit" type="button" value="Enviar" onclick="new Ajax.Updater('checar', '_admPanel/_executarJogo/ex.pesqBan.php', {method: 'post', asynchronous:true, parameters:Form.serialize(document.editar)}); esperar('checar');"></div>
