            ...
            <table width="100%" height="74" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td rowspan="5" width="31" align="center" valign="top" style="background-color:#aeaeae;padding: 8px 4px 0px 6px;">
                  ...
                  <input class="ssubmit" onclick="new Ajax.Updater('container', '_shop/_functionCompra/buy.CalcularVip.php?Id=<?=anti_injection($_GET['Id'])?>', {method: 'get', asynchronous:true, parameters:Form.serialize(document.test)}); esperar('container');" type="button" value="Calcular" />
              ...
              <tr>
                ...
                <td width="4"></td>
                 <td height="15" style="background-color:#aeaeae;padding: 0px 4px 0px 4px;" valign="center">
                  <div style="float: left; padding: 2px 5px;"><input type="text" id="unidade" name="unidade" value="1" maxlength="2" class="ffield" style="width: 20px; text-align: center;" readonly="readonly"></div>
                  <div style="float: left; padding-left: 10px; line-height: 20px;">Max: 1 unidade</div>
                </td>
              </tr>
              <tr><td height="4"></td></tr>
              <tr>
