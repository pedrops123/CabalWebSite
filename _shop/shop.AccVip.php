...
<div class="spages"><b>CONTA VIP</b>
</div>
 ...
 $PegaInfo = mssql_query("SELECT * FROM CabalCash.dbo.ShopItems where Category=2 and Available>0 order by weight asc"); 
            ...
            <table width="100%" height="54" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td rowspan="5" width="60" align="center" valign="top" style="background-color:#aeaeae;padding: 0px 4px 0px 4px;">
                  <input class="ssubmit" onclick="new Ajax.Updater('container', '_shop/_functionCompra/buy.GeralVip.php?Id=<?=$ResultInfo['Id']?>', {method: 'get', asynchronous:true, evalScripts:true}); esperar('container');" type="button" value="selecione" />
                <td>
              </tr>
