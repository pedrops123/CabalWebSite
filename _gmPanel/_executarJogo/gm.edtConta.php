...
?>
          ...
          <td align="center"> <input class="ssubmit" onclick="new Ajax.Updater('container', '_gmPanel/_executarJogo/ex.pesqConta.php?ID=<?=$ResultInfo['ID']?>', {method: 'get', asynchronous:true, evalScripts:true}); esperar('container');" type="button" value="selecione" /></td> 
          </tr>
<?
        }
?>   
...
?>
          ...
          <td align="center"><input class="ssubmit" onclick="new Ajax.Updater('container', '_gmPanel/_executarJogo/ex.pesqChar.php?Name=<?=$ResultInfo['Name']?>', {method: 'get', asynchronous:true, evalScripts:true}); esperar('container');" type="button" value="selecione" /></td> 
          </tr>
<?
        }
?>   
...
<div id="fbody" class="fbody">
  ...
  <div class="flabel" style="text-align: center;"><input name="sbmtPesqAcc" class="fsubmit" type="button" value="Pesquisar" onclick="new Ajax.Updater('checar', '_gmPanel/_executarJogo/gm.edtConta.php', {method: 'post', asynchronous:true, parameters:Form.serialize(document.registro)}); esperar('checar');"></div>
